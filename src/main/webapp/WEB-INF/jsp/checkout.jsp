  ...
  <div class="container">
    ...
    <c:forEach var="c" items="${cart}">
		...
		<%-- 	 <label>Name</label>&nbsp;<input type="text" id="custname" value="${user.name}"  style="width:70%" disabled><br><br>
             <label>Email</label> &nbsp;    <input type="text"id="email"  value="${user.id}"  style="width:70%" disabled><br><br>
              <label>Phone</label> &nbsp;   <input type="text" id="phone" value="${user.phone}"  style="width:70%" disabled><br><br>
